...
describe("Commands", function() {
  ...
  describe("Ability.execute()", function() {
    it("handles check", function () {
      ...
      assert.equal(
        Commands.Ability.execute(character, "athletics", formatRoll),
    ...
    it("handles check with advantage", function () {
      ...
      assert.equal(
        Commands.Ability.execute(character, "athletics with adv", formatRoll),
        "formatted-evaluation"
      );
    });
  ...
  describe("Attack.execute()", function() {
    const attacks = [
      {
        ...
        regex: /Greatsword with Smite|GS\+S/i
      },
      {
        name: "Greatsword",
        toHit: "1d20 + 10",
        damage: "2d6 + 6",
        regex: /Greatsword|GS/i
      }
    ];
    ...
    it("handles check", function () {
      ...
      assert.equal(
        Commands.Attack.execute(character, "Greatsword with Smite", formatRoll),
        "formatted-evaluation"
      );
    });
    ...
    it("handles check with advantage", function () {
      ...
      assert.equal(
        Commands.Attack.execute(
          character,
          "Greatsword with Smite with adv",
          formatRoll
        ),
        "formatted-evaluation"
      );
    ...
    it("handles check with disadvantage", function () {
      ...
      assert.equal(
        Commands.Attack.execute(
          character,
          "Greatsword with Smite with disadvantage",
          formatRoll
        ),
        "formatted-evaluation"
      );
    ...
    it("handles check with purpose", function () {
      ...
      assert.equal(
        Commands.Attack.execute(
          character,
          "Greatsword with Smite against foes",
          formatRoll
        ),
        "formatted-evaluation"
      );
  ...
  describe("Damage.execute()", function() {
    ...
    it("handles check", function () {
      ...
      assert.equal(
        Commands.Damage.execute(character, "Greatsword with Smite", formatRoll),
        "formatted-evaluation"
      );
    });
  ...
  describe("Initiative.execute()", function() {
    it("handles check", function () {
      ...
      assert.equal(
        Commands.Initiative.execute(character, "", formatRoll),
        "formatted-evaluation"
      );
    });
    ...
    it("handles check with advantage", function () {
      ...
      assert.equal(
        Commands.Initiative.execute(character, "with adv", formatRoll),
        "formatted-evaluation"
      );
    });
    ...
    it("handles check with disadvantage", function () {
      ...
      assert.equal(
        Commands.Initiative.execute(character, "with disadvantage", formatRoll),
        "formatted-evaluation"
      );
    });
    ...
    it("handles check with purpose", function () {
      ...
      assert.equal(
        Commands.Initiative.execute(character, "for mortal combat", formatRoll),
        "formatted-evaluation"
      );
    });
  ...
  describe("Save.execute()", function() {
    it("handles check", function () {
      ...
      assert.equal(
        Commands.Save.execute(character, "CON", formatRoll),
        "formatted-evaluation"
      );
    });
    ...
    it("handles check with advantage", function () {
      ...
      assert.equal(
        Commands.Save.execute(character, "CON with adv", formatRoll),
        "formatted-evaluation"
      );
    });
    ...
    it("handles check with disadvantage", function () {
      ...
      assert.equal(
        Commands.Save.execute(character, "CON with disadvantage", formatRoll),
        "formatted-evaluation"
      );
    });
    ...
    it("handles check with purpose", function () {
      ...
      assert.equal(
        Commands.Save.execute(character, "CON for near death", formatRoll),
        "formatted-evaluation"
      );
    });
