...
function toExpressionString(evaluations) {
  return evaluations
    .map(evaluation => evaluation.expression.toString())
    .toString();
}
...
describe("Character", function() {
  describe("from()", function() {
    it("handles bard", function() {
      ...
      assert.equal(character.classes[0].toString(), "Lore Bard 10");
    ...
    it("handles paladin", function() {
      ...
      assert.equal(character.level, 10);
      assert.equal(character.classes.length, 1);
      assert.equal(character.classes[0].toString(), "Vengeance Paladin 10");
  ...
  describe("rollAbilityCheck()", function() {
    ...
    it("handles check", function() {
      assert.equal(
        toExpressionString(character.rollAbilityCheck("Athletics")),
        "1d20 + 9 for Athletics"
      );
      assert.equal(
        toExpressionString(character.rollAbilityCheck("INT")),
        "1d20 - 1 for Intelligence"
      );
    });
    ...
    it("handles check with advantage", function() {
      assert.equal(
        toExpressionString(
          character.rollAbilityCheck("Athletics", "", RollDecorator.Advantage)
        ),
        "2d20K1 + 9 for Athletics"
      );
      assert.equal(
        toExpressionString(
          character.rollAbilityCheck("INT", "", RollDecorator.Advantage)
        ),
    ...
    it("handles check with disadvantage", function() {
      assert.equal(
        toExpressionString(
          character.rollAbilityCheck(
            "Athletics",
            "",
            RollDecorator.Disadvantage
          )
        ),
        "2d20k1 + 9 for Athletics"
      );
      assert.equal(
        toExpressionString(
          character.rollAbilityCheck("INT", "", RollDecorator.Disadvantage)
        ),
        "2d20k1 - 1 for Intelligence"
      );
    });
    ...
    it("handles check with purpose", function() {
      assert.equal(
        toExpressionString(
          character.rollAbilityCheck("Athletics", "to be heroic")
        ),
  ...
  describe("rollAttackToHit()", function() {
    ...
    it("handles check with advantage", function() {
      assert.equal(
        toExpressionString(
          character.rollAttackToHit(
            "Greatsword with Smite",
            "",
            RollDecorator.Advantage
          )
        ),
    ...
    it("handles check with purpose", function() {
      assert.equal(
        toExpressionString(
          character.rollAttackToHit("Greatsword with Smite", "against foes")
        ),
  ...
  describe("rollAttackDamage()", function() {
    ...
    it("handles check with purpose", function() {
      assert.equal(
        toExpressionString(
          character.rollAttackDamage("Greatsword with Smite", "against foes")
        ),
  ...
  describe("rollInitiative()", function() {
    ...
    it("handles check", function() {
      assert.equal(
        toExpressionString(character.rollInitiative()),
        "1d20 + 0 for Initiative"
      );
    });
    ...
    it("handles check with advantage", function() {
      assert.equal(
        toExpressionString(
          character.rollInitiative("Initiative", RollDecorator.Advantage)
        ),
    ...
    it("handles check with disadvantage", function() {
      assert.equal(
        toExpressionString(
          character.rollInitiative("Initiative", RollDecorator.Disadvantage)
        ),
        "2d20k1 + 0 for Initiative"
      );
    });
    ...
    it("handles check with purpose", function() {
      assert.equal(
        toExpressionString(character.rollInitiative("mortal combat")),
        "1d20 + 0 for mortal combat"
      );
    });
  });
  ...
  describe("rollSavingThrow()", function() {
    ...
    it("handles check", function() {
      assert.equal(
        toExpressionString(character.rollSavingThrow("CON")),
        "1d20 + 5 for Constitution save"
      );
    });
    ...
    it("handles check with advantage", function() {
      assert.equal(
        toExpressionString(
          character.rollSavingThrow("CON", "", RollDecorator.Advantage)
        ),
    ...
    it("handles check with disadvantage", function() {
      assert.equal(
        toExpressionString(
          character.rollSavingThrow("CON", "", RollDecorator.Disadvantage)
        ),
        "2d20k1 + 5 for Constitution save"
      );
    });
